...
%% \end{enumerate}
 ...
 %% for the application-specific behaviour we seek.
 The extension detects
 exploits in the HTML by using signature definitions and maintains a
 local database of signatures. We leave the design of an update mechanism
 to future work, but in the simplest form, database updates are
 bundled with new revisions of the extension.
 %
 The extension translates signature definitions into
