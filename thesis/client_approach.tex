...
%
At a high-level, it protects against \xss as follows (see \autoref{fig:xsnare}): A user requests a page, \url{example.com}.
%
The response may or may not contain
malicious \xss payloads.
%
Before the browser renders the document, the \sys extension analyzes
...
(malicious) could be injected, unchecked.  The extension's sanitizer
