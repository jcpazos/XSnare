...
Our basic signature definition thus specifies a match expression to
locate an injection's start and endpoints, and any sanitization to be
done between these two endpoints. We discuss the difficulty of
supporting pages with multiple dynamic content injection points in
later sections.

Our signatures are defined with these two assumptions in mind: first,
...
We believe CVEs are an ideal growing source of signature definitions. Since previous
