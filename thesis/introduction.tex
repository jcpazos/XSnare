...
% Can something be said about the dom-XSS attacks?

Some software vendors respond to \xss whenever a vulnerability is disclosed.
After disclosure (but hopefully before), security conscious developers hopefully will publish patches. When the software affected in released in the form of
...
Sadly, users are effectively left at the mercy of developers and administrators if they wish to browser the web safely.
