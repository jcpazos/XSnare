...
Each layer of the web application stack  (Figure~\ref{fig:web_architecture}) opens different defence options against \xss. Note that solutions at different layers are often complementary:
