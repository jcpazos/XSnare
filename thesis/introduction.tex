...
vulnerabilities. A 2017 report showed that 50\% of websites
contained at least one \ac{XSS} vulnerability~\cite{Acunetix}. Countermeasures
exist, but many of them lack widespread deployment.
Many of these defenses require server-side and browser modifications~\cite{Jim:2007:DSI:1242572.1242654,Nadji:2009,Wurzinger:2009:SMX:1656360.1656379,Sundareswaran:2012:XHS:2352970.2352994} and/or additional front-end developer effort~\cite{10.1007/978-3-319-66399-9_7}. Other solutions disable client-side
...
solutions have not seen widespread adoption because they are
not practical: developers might not be willing, or might not have the
resources or expertise to implement them. Furthermore, even
when software patches are available, many 
administrators do not apply them immediately: one study found that
61\% of WordPress websites were running a version with known security
vulnerabilities~\cite{Sucuri}, and another study found that 30.95\% of
Alexa's top 1 Million sites run a vulnerable version of WordPress~\cite{wpwhitesecurity}.
As more and more websites use client-side
technologies\footnote{In 2012 almost 100\% of the Alexa top 500 sites were using
