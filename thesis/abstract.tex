...
\\We evaluate the applicability of our approach by studying the latest 100 CVEs related to XSS attacks in WordPress, and find that most of these exploits can be defended against with our tool. Initial peformance evaluation has resulted in an overhead of at most 2x on webpage load times. 
