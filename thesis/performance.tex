...
\begin{itemize}
	...
	\item Extension cold cache: As above, but Firefox is loaded with the extension installed.
	...
	\item Extension warm cache: As above, but Firefox is launched with the extension installed.
\end{itemize}
