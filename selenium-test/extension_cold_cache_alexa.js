		...
		for (j=0; j<trials; j++) {
			...
			try {
				start = new Date();
			 	...
			 	end1 = new Date();
				await driver.wait(driver.get(urls[i]), 20000);
				end2 = new Date();
				...
				if (driver) {
					...
					await driver.quit();
					end5 = new Date();
					/*console.log("Time to start driver: " + (end1-start));
