...
async function initTests(start, end) { 
	...
	for (i=start; i<end; i++) {
		...
		stream = fs.createWriteStream("./top_results/extension_cold_top_results.txt", {flags:'a'});
		...
		stream = fs.createWriteStream("./top_results/no_extension_cold_top_results.txt", {flags:'a'});
		stream.write(JSON.stringify(loadTimes));
		stream.write(",");
		stream.end();
		...
		stream = fs.createWriteStream("./top_results/extension_warm_top_results.txt", {flags:'a'});
		stream.write(JSON.stringify(loadTimes));
		stream.write(",");
		stream.end();
		...
		stream = fs.createWriteStream("./top_results/no_extension_warm_top_results.txt", {flags:'a'});
		stream.write(JSON.stringify(loadTimes));
		stream.write(",");
		stream.end();
	}
...
function processResults() {
	...
	stream = fs.createWriteStream("./top_results/speedups_cold_responseStart.txt", {flags:'a'});
	stream.write(JSON.stringify(speedups_cold_responseStart));
	stream.write(",");
	stream.end();

	stream = fs.createWriteStream("./top_results/speedups_cold_responseEnd.txt", {flags:'a'});
	stream.write(JSON.stringify(speedups_cold_responseEnd));
	stream.write(",");
	stream.end();

	stream = fs.createWriteStream("./top_results/speedups_cold_domResponse.txt", {flags:'a'});
	stream.write(JSON.stringify(speedups_cold_domResponse));
	stream.write(",");
	stream.end();

	stream = fs.createWriteStream("./top_results/speedups_warm_responseStart.txt", {flags:'a'});
	stream.write(JSON.stringify(speedups_warm_responseStart));
	stream.write(",");
	stream.end();

	stream = fs.createWriteStream("./top_results/speedups_warm_responseEnd.txt", {flags:'a'});
	stream.write(JSON.stringify(speedups_warm_responseEnd));
	stream.write(",");
	stream.end();

	stream = fs.createWriteStream("./top_results/speedups_warm_domResponse.txt", {flags:'a'});
	stream.write(JSON.stringify(speedups_warm_domResponse));
	stream.write(",");
	stream.end();

	stream = fs.createWriteStream("./top_results/extension_cold_sizes.txt", {flags:'a'});
