...
/*run_tests(0, urls.length).then(function (loadTimes) {
	noExtensionLoadTimes = noExtensionLoadTimes.concat(loadTimes);
	console.log("Load times without extension running: " + noExtensionLoadTimes);
});*/
